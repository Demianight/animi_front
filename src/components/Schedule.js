...
function Schedule() {
  const periods = ['Первая пара', 'Вторая пара', 'Третья пара', 'Четвертая пара', 'Пятая пара'];
  const schedule = [
    { id: '1', group: 'А-10-24', subject: 'Математический анализ', time: '09:20 - 10:55', period: 'Первая пара', hall: 'Н-202'},
    { id: '2', group: 'А-10-24', subject: 'Физика', time: '13:45 - 15:20', period: 'Третья пара', hall: 'Б-200'},
  ];
